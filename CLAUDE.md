...
**YOU ARE IN: `necklace/polecats/chrome/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/necklace/` (rig root) or other directories
...
**Your mail address:** `necklace/polecats/chrome`
**Your rig:** necklace
**Your Witness:** `necklace/witness`
...
| Ask Witness for help | `gt mail send necklace/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`necklace/witness`) when:
...
```bash
gt mail send necklace/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
